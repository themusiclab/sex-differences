...
library(plyr)
SI_dat <- readRDS("../data/clean-person-level-data.rds") %>% 
  select("music_tap", "out_of_tune", "music_skill", "music_listen", "lessons_enjoy", "lessons_peers", "theory_training", "music_feel", "music_listen_time", "familiarity_tradmusic") %>%
